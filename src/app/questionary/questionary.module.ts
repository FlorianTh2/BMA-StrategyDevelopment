...
@NgModule({
  declarations: [QuestionaryComponent, QaListComponent, QaMessageComponent, QaDisplayPartialModelComponent],
  imports: [CommonModule, QuestionaryRoutingModule, SharedModule]
})
